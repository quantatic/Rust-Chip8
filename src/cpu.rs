...
impl<'a, 'b> Cpu<'a, 'b> {
    ...
    pub fn print_opcode(&self, opcode: u16) {
        ...
        match nibbles {
            ...
            (0x3, x, _, _) => println!("SE V{:02}, 0x{:02x}", x, nn),
            (0x4, x, _, _) => println!("SNE V{:02}, 0x{:02x}", x, nn),
            (0x5, x, y, 0x0) => println!("SE V{:02}, V{:02}", x, y),
            (0x6, x, _, _) => println!("LD V{:02}, 0x{:02}", x, nn),
            (0x7, x, _, _) => println!("ADD V{:02}, 0x{:02}", x, nn),
            (0x8, x, y, 0x0) => println!("LD V{:02}, V{:02}", x, y),
            (0x8, x, y, 0x1) => println!("OR V{:02}, V{:02}", x, y),
            (0x8, x, y, 0x2) => println!("AND V{:02}, V{:02}", x, y),
            (0x8, x, y, 0x3) => println!("XOR V{:02}, V{:02}", x, y),
            (0x8, x, y, 0x4) => println!("ADD V{:02}, V{:02}", x, y),
            (0x8, x, y, 0x5) => println!("SUB V{:02}, V{:02}", x, y),
            (0x8, x, _, 0x6) => println!("SHR V{:02}", x),
            (0x8, x, y, 0x7) => println!("SUBN V{:02}, V{:02}", x, y),
            (0x8, x, _, 0xE) => println!("SHR V{:02}", x),
            (0x9, x, y, 0x0) => println!("SNE V{:02}, V{:02}", x, y),
            (0xA, _, _, _) => println!("LD I, 0x{:04x}", nnn),
            (0xB, _, _, _) => println!("JP V00, 0x{:04x}", nnn),
            (0xC, x, _, _) => println!("RND V{:02}, 0x{:02x}", x, nn),
            (0xD, x, y, n) => println!("DRW V{:02}, V{:02}, 0x{:01x}", x, y, n),
            (0xE, x, 0x9, 0xE) => println!("SKP V{:02}", x),
            (0xE, x, 0xA, 0x1) => println!("SKNP V{:02}", x),
            (0xF, x, 0x0, 0x7) => println!("LD V{:02}, DT", x),
            (0xF, x, 0x0, 0xA) => println!("LD V{:02}, K", x),
            (0xF, x, 0x1, 0x5) => println!("LD DT, V{:02}", x),
            (0xF, x, 0x1, 0x8) => println!("LD ST, V{:02}", x),
            (0xF, x, 0x1, 0xE) => println!("ADD I, V{:02}", x),
            (0xF, x, 0x2, 0x9) => println!("LD F, V{:02}", x),
            (0xF, x, 0x3, 0x3) => println!("LD B, V{:02}", x),
            (0xF, x, 0x5, 0x5) => println!("LD [I], V{:02}", x),
            (0xF, x, 0x6, 0x5) => println!("LD V{:02}, [I]", x),
